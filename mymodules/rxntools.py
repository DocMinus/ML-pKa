...
# -*- coding: utf-8 -*-
"""
Version 2.1.2 (Mar. 08, 08:00:00 2023)
Update: 2023-03-10
...
# my imports
from .ids import (ELEMENTS_DICT, RDKIT_SMARTS, RDKIT_TD, RDKIT_TD_HEADERS,
                  REGEX, REGEX_LOW)
...
def elemental_tds_multi(schmiles: list) -> pd.DataFrame:
    ...
    """
    print("...Calculation EA based TDs...")
...
def transform_descriptors_multi(schmiles: list) -> pd.DataFrame:
    """
    ...
    """
    print("...Calculating transforms (smarts) descriptors...")
