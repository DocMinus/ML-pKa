...
# coding: utf-8
"""
temporary: resuse script to extract novartis and avlilumove data (never mind if some dups are gone)
"""
...
def main():
    ...
    # keep rows with Source = "Novartis"
    merged_df = in_mols[in_mols["Source"] == "Novartis"]
